...
AABFountain::AABFountain()
{
	...
	//리플리케이션 활성화를 위한 옵션 설정.(이 액터는 이제 서버 복제 대상이라는걸 True)
	bReplicates = true;
...
void AABFountain::BeginPlay()
{
	...
	//
	// 		// FLinearColor NewLightColor = FLinearColor::FLinearColor(
	// 		// FMath::RandRange(0.0f, 1.0f),
	// 		// FMath::RandRange(0.0f, 1.0f),
	// 		// FMath::RandRange(0.0f, 1.0f),
	// 		// 1.0f);
	...
	// 		// OnRep_ServerLightColor();
	//
	// 		const FLinearColor NewLightColor = FLinearColor::FLinearColor(
	// 			FMath::RandRange(0.0f, 1.0f),
	// 			FMath::RandRange(0.0f, 1.0f),
	// 			FMath::RandRange(0.0f, 1.0f),
	// 			1.0f);
...
void AABFountain::Tick(float DeltaTime)
{
	...
	// 클라이언트.(ReplicatedUsing을 사용해서 콜백함수로 바꾸기 위해 주석처리.)
	else
	{
